...
trainloader = torch.utils.data.DataLoader(trainset, batch_size=50, shuffle=True, num_workers=1, pin_memory=True)
...
model_dict = {
        ...
        'VGGNOBN_a1_w1': VGG_nobn_quant('VGG', 1, 1),
        'VGGNOBN_a2_w1': VGG_nobn_quant('VGG', 2, 1),
        'VGGNOBN_a2_w2': VGG_nobn_quant('VGG', 2, 2),
        'VGGTNOBN_a1_w1': VGG_nobn_quant('VGGT', 1, 1, 256),
        'VGGTNOBN_a2_w2': VGG_nobn_quant('VGGT', 2, 2, 256),
        'VGGTNOBN_a2_w1': VGG_nobn_quant('VGGT', 2, 1, 256),
        'VGG': VGG('VGG'),
        'VGG16': VGG('VGG16'),
